...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
        KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_BSPC,                        KC_ESC, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_BSPC,
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_ENT,                               KC_TAB, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_ENT,
        KC_CAPS, KC_A, KC_S, LT(2, KC_D), KC_F, KC_G,                               KC_CAPS, KC_H, KC_J, KC_K, KC_L, KC_SCLN,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_DEL,                              KC_RSFT, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RO,
        TG(2), LT(3 ,KC_PSCR), KC_LCTL, KC_LGUI, KC_LALT, LALT_T(KC_LANG2), KC_SPC, KC_SPC, LT(1, KC_LANG1), KC_RALT, KC_RGUI, KC_RCTL, MO(3), KC_DEL
    ),
