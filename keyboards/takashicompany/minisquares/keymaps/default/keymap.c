...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        LSFT_T(KC_Z), LGUI_T(KC_X), KC_C, LALT_T(KC_V), LSFT_T(KC_B), LT(2, KC_N), LT(1, KC_M), KC_COMM, LCTL_T(KC_DOT), KC_BSPC
    ),
    
    [1] = LAYOUT(
        KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, 
        LCTL_T(KC_EQL), KC_LBRC, KC_SLSH, KC_MINS, KC_INT1, KC_SCLN, KC_QUOT, KC_RBRC, KC_NUHS, KC_INT3, 
        LSFT_T(KC_PLUS), KC_LCBR, KC_QUES, KC_UNDS, LSFT(KC_INT1), KC_SPC, KC_DQUO, KC_RCBR, LSFT(KC_NUHS), LSFT(KC_INT3)
    ),
    ...
    [3] = LAYOUT(
        LT(7, KC_Q), KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P,
        KC_A, KC_S, LT(6, KC_D), KC_F, KC_G, KC_H, KC_J, LT(6, KC_K), KC_L, KC_ENT,
        LSFT_T(KC_Z), LGUI_T(KC_X), KC_C, LALT_T(KC_V), LSFT_T(KC_B), LT(5, KC_N), LT(4, KC_M), KC_COMM, LCTL_T(KC_DOT), KC_BSPC
    ),
    ...
    [6] = LAYOUT(
        ...
        KC_LSFT, KC_LGUI, KC_LALT, KC_LNG2, KC_TAB, KC_SPC, KC_LNG1, KC_NO, KC_NO, KC_DEL
    ), 
