...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
        ...
        KC_LCTL, KC_A, KC_S, LT(3, KC_D), KC_F, KC_G, RADIALEX, KC_H, KC_J, LT(3, KC_K), KC_L, KC_ENT, KC_ENT,
    ...
    LAYOUT(
        KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, ROT_L15, ROT_R15, RADIALEX, KC_NO, KC_NO, KC_TRNS,
